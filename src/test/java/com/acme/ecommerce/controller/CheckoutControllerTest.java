...
public class CheckoutControllerTest {
	...
	@Test
	public void postCouponValidationSuccess() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.post("/checkout/coupon").param("couponCode", "abcde")).andDo(print())
				.andExpect(status().is3xxRedirection())
				.andExpect(redirectedUrl("shipping"));
	}

	@Test
	public void postCouponValidationFailure() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.post("/checkout/coupon").param("code", "abc"))
				.andDo(print())
				.andExpect(status().is3xxRedirection())
				.andExpect(redirectedUrl("/checkout/coupon"))
				.andExpect(
						flash().attribute("org.springframework.validation.BindingResult.couponCode",
